...
class SettingsView(Gtk.Box):
    ...
    def _on_save_clicked(self, button):
        ...
        try:
            # General settings
            self.config.set("general", "minimize_to_tray", self.minimize_to_tray_switch.get_active())
            ...
            # Advanced settings
            self.config.set("advanced", "discovery_timeout", self.discovery_timeout_spin.get_value_as_int())
            self.config.set("advanced", "connection_timeout", self.connection_timeout_spin.get_value_as_int())
