...
class CastManager(GObject.Object):
    ...
    def _simulate_casting(self):
        ...
        _frame_rate = self.config.get("streaming", "frame_rate", 30)  # noqa: F841
        ...
        while not self._stop_event.is_set():
            ...
            if now - last_update >= 1.0:
                ...
                instant_bitrate = (
                    (self._stats.data_transferred - last_bytes) * 8 / (now - last_update)
                )
                ...
                # Log statistics
                logger.debug(
                    f"Casting stats: {instant_bitrate/1_000_000:.2f} Mbps, "
