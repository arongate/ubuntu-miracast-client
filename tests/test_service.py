...
class TestServiceManager(unittest.TestCase):
    ...
    def test_service_file_path(self):
        ...
        expected_path = (
            Path.home() / ".config" / "systemd" / "user" / "ubuntu-miracast-client.service"
        )
    ...
    def test_enable_service_calls_correct_commands(self, mock_run):
        ...
        with patch.object(Path, "mkdir"), patch.object(self.manager, "_create_service_file"):
    ...
    def test_disable_service_calls_correct_commands(self, mock_run):
        ...
        with (
            patch.object(self.manager, "is_service_running", return_value=False),
    ...
    def test_start_service_calls_correct_commands(self, mock_run):
        ...
        mock_run.assert_called_with(
            ["systemctl", "--user", "start", "ubuntu-miracast-client"], check=True
        )
    ...
    def test_stop_service_calls_correct_commands(self, mock_run):
        ...
        mock_run.assert_called_once_with(
            ["systemctl", "--user", "stop", "ubuntu-miracast-client"], check=True
        )
    ...
    def test_start_service_enables_if_not_enabled(self, mock_run):
        ...
        with (
            patch.object(self.manager, "is_service_enabled", return_value=False),
